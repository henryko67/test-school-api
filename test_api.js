...
function createSchoolSearchPipeline(q, indexName) {
  return [
    {
      $search: {
        index: indexName,
...
function createLocationSearchPipeline(q) {
  return [
    {
      $search: {
...
app.get("/api/search", async (req, res) => {
  try {
    ...
    const locationPipeline =
      createLocationSearchPipeline(q, "location_search");
    ...
    const schoolResults = [
      ...publicResults.map(school => ({
        ...school,
        sector: "public"
      })),

      ...privateResults.map(school => ({
        ...school,
        sector: "private"
      }))
    ];
